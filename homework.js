(() => {
  ...
  style.textContent += `.class-shell,.class-main,.class-conversation{min-height:0;overflow:hidden}.class-conversation{height:100%;display:flex;flex-direction:column}.conversation-head,.today-homework,.message-compose{flex:0 0 auto}.class-conversation .message-stream{height:auto;min-height:0;flex:1 1 0;overflow-y:auto;overscroll-behavior:contain}.message-compose{position:relative;z-index:1}`;
