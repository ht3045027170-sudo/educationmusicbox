(() => {
  ...
  async function loadBank(){
    ...
    const query=new URLSearchParams({page:1,pageSize:100,systemCode:'gaokao',subject:bankMode,status:document.getElementById('twStatus').value,difficulty:document.getElementById('twDifficulty').value,search:document.getElementById('twSearch').value});
