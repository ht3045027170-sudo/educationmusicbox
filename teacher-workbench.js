(() => {
  ...
  style.textContent = `
    ...
    /* Editorial override: 教师端与学生端共享音乐出版物式视觉语言。 */
    .tw-hero button,.tw-library button,.tw-editor button,.tw-type-dialog button,.tw-actions>button,.tw-actions b,.tw-metrics,.tw-library,.tw-bank-tabs,.tw-filters input,.tw-filters select,.tw-question,.tw-status,.tw-type-dialog,.tw-type-groups [data-type],.tw-quick-body input,.tw-quick-body select,.tw-quick-body fieldset,.tw-editor,.tw-settings input,.tw-settings select,.tw-compose input,.tw-compose select,.tw-compose textarea,.tw-type-rail button,.tw-student-card,.tw-student-score,.tw-student-options div{border-radius:0}
    .tw-hero{min-height:210px;padding:28px 0 38px;border-bottom-color:var(--tw-ink)}.tw-hero h1{font-size:clamp(52px,7vw,94px);letter-spacing:-.075em}.tw-hero button{border:1px solid var(--tw-ink);box-shadow:4px 4px 0 var(--tw-accent)}
    .tw-actions{gap:1px;border:1px solid var(--tw-ink);background:var(--tw-ink)}.tw-actions>button{min-height:142px;align-items:flex-start;border:0;background:var(--tw-paper)}.tw-actions>button:hover{background:var(--tw-accent);color:#fff}.tw-actions b{background:transparent;color:var(--tw-accent);font:500 30px Georgia,serif}
    .tw-metrics{border-color:var(--tw-ink);box-shadow:8px 8px 0 rgba(69,39,30,.09)}.tw-library{border-color:var(--tw-ink);box-shadow:10px 10px 0 rgba(69,39,30,.08)}.tw-library h2{font-size:40px;letter-spacing:-.05em}.tw-question{border-color:var(--tw-line)}.tw-question:hover{border-color:var(--tw-ink)}
    .tw-type-dialog,.tw-editor{border:1px solid var(--tw-ink);box-shadow:14px 14px 0 rgba(42,24,18,.25)}.tw-type-groups section>div{gap:1px;border:1px solid var(--tw-ink);background:var(--tw-ink)}.tw-type-groups [data-type]{border:0}.tw-type-groups [data-type]:hover{background:var(--tw-accent);color:#fff}.tw-student-card{border:1px solid var(--tw-ink);box-shadow:8px 8px 0 rgba(111,52,28,.12)}`;
